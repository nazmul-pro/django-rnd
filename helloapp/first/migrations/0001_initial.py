# Generated by Django 2.0.2 on 2018-02-03 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first.Family')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
